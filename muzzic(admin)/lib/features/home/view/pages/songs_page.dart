...
class _SongsPageState extends ConsumerState<SongsPage> {
  ...
  final songsProvider = FutureProvider.autoDispose<List<SongModel>>((ref) async {
    final response = ref.watch(homeViewmodelProvider.notifier).getSongsList();
    return response;
  });

  final allSongsProvider = FutureProvider<List<SongModel>>((ref) async {
    final response = ref.watch(homeViewmodelProvider.notifier).getAllSongs();
    return response;
  });
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return InkWell(
                                onTap: () {
                                  ...
                                  ref.watch(homeLocalRepositoryProvider).markAsRecentlyPlayed(song);
                                  setState(() {});
                                },
                                child: Container(
